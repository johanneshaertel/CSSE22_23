...
rgl.linestrips(mus, pmax(0,h1 * (mus - x)^2 * 0.5 + y(x,z)), rep(0, length(mus)), color = "orange")
rgl.linestrips(rep(0, length(sigmas)), pmax(0,h2 * (sigmas - z)^2 * 0.5 + y(x,z)), sigmas, color = "orange")